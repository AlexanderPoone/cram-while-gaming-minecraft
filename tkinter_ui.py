# Find DW-logs from Drive (Installation package). Can't find!
...
def create_window():
    ...
    header = tk.Label(window, text="Cram while Playing - Minecraft", font=("Arial", 16, "bold"), bg='#1a1a1a', fg='white')
    ...
    # Version dropdown
    version_label = tk.Label(control_frame, text="Version:", bg='#1a1a1a', fg='white')
    ...
    quizlet_button = tk.Button(control_frame, text="From Quizlet", command=show_quizlet_entry, bg='#333333', fg='white', activebackground='#4d4d4d')
    quizlet_button.pack(side=tk.LEFT, padx=(0, 5))

    # Button for Minecraft grammar cram
    mc_grammar_button = tk.Button(control_frame, text="(From MC) Cram Grammatical Gender", command=execute_script, bg='#333333', fg='white', activebackground='#4d4d4d')
...
def show_quizlet_entry():
    ...
    # ID Entry
    id_label = tk.Label(quizlet_window, text="Enter Quizlet ID:", bg='#1a1a1a', fg='white')
    id_label.pack(pady=5, padx=20)
    id_entry = tk.Entry(quizlet_window, bg='#333333', fg='white')
    id_entry.pack(pady=5, padx=20)

    # Buttons
    button_frame = tk.Frame(quizlet_window, bg='#1a1a1a')
    button_frame.pack(pady=5, padx=20)
    enter_button = tk.Button(button_frame, text="Enter", command=lambda: print("Enter clicked with ID:", id_entry.get()), bg='#333333', fg='white', activebackground='#4d4d4d')
    enter_button.pack(side=tk.LEFT, padx=5)
    cancel_button = tk.Button(button_frame, text="Cancel", command=quizlet_window.destroy, bg='#333333', fg='white', activebackground='#4d4d4d')
